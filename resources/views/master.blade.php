...
<html >
<head>
  <!-- Site made with Mobirise Website Builder v4.8.4, #m -->
  <meta charset="UTF-8">
  ...
  <section class="menu cid-qTkzRZLJNu" once="menu" id="menu1-0">
    ...
    <nav class="navbar navbar-expand beta-menu navbar-dropdown align-items-center navbar-fixed-top navbar-toggleable-sm">
        ...
        <div class="menu-logo">
            <div class="navbar-brand">
                <span class="navbar-logo">
                    <a href="#top">
                         <img src="assets/images/003-restaurant-cutlery-circular-symbol-of-a-spoon-and-a-fork-in-a-circle-122x122.png" alt=“Fooder” title="" style="height: 3.8rem;">
                    </a>
                </span>
                <span class="navbar-caption-wrap"><a class="navbar-caption text-black display-5" href="#m">FOODER</a></span>
            </div>
        </div>
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            ...
            <div class="navbar-buttons mbr-section-btn"><a class="btn btn-sm btn-black display-4" href="#m"><span class="mbri-login mbr-iconfont mbr-iconfont-btn"></span>
